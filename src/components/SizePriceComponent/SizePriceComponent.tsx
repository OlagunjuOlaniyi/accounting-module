        ...
        <div className="input-component">
          ...
          {customSize ? (
            ...
            <select
              ...
              value={sizePrice.size}
              onChange={(e) => {
                const isSizeAlreadyExists = allSizePrices.find(
                  (item: { size: string }) => item.size === e.target.value
                );
                if (isSizeAlreadyExists) {
                  toast.error(`Action not successfully, duplicated size can not be added to product `);
                  return;
                } else {
                  sizePrice.size = e.target.value;
                }
