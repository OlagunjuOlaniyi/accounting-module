...
import {
  ...
  useRecordCashWithdrawal,
} from '../../../hooks/mutations/chartofAccounts';
import { useGetBankList } from '../../../hooks/queries/banks';
import { useAddBank } from '../../../hooks/mutations/bank';

const RecordCashWithdrawal = ({ close }: any) => {
  ...
  const { mutate, isLoading } = useRecordCashWithdrawal();
    ...
    <div className='record-income'>
      <div style={{ background: '#FBFDFE' }}>
        ...
        <div className='record-income__heading'>
          <h4>Record cash withdrawal</h4>
          <p>
            Select the asset amount, and date of the cash withdrawal you want to
            record
          </p>
        </div>
      </div>
...
export default RecordCashWithdrawal;
