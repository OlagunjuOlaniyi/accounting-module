...
const RecordBankWithdrawal = ({ close }: any) => {
    ...
    <div className='record-income'>
      <div style={{ background: '#FBFDFE' }}>
        ...
        <div className='record-income__heading'>
          <h4>Record bank withdrawal</h4>
          <p>
            Select the asset amount, and date of the bank withdrawal you want to
            record
          </p>
        </div>
      </div>
...
export default RecordBankWithdrawal;
